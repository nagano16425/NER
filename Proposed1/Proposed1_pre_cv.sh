...
#
# HOW TO USE
# Command:bash Proposed1_pre_cv.sh (start) (end) (counter)
#
for (( i = $1 ; i <= $2 ; i+=$3 ))
do
python3 test.py 12 34 $i > log_pre_Traffic34_$i.txt
python3 test.py 34 12 $i > log_pre_Traffic12_$i.txt
done
for (( i = $1 ; i <= $2 ; i+=$3 ))
do
    ...
    cat EviHRNN12_$i.iob2 EviHRNN34_$i.iob2 > resultHRNN_$i.iob2
