...
#
# HOW TO USE
# Command:bash basic1-1_pre_cv.sh (start) (end) (counter)
#
for (( i = $1 ; i <= $2 ; i+=$3 ))
do
python3 basic1-1.py 12 34 $i > log_pre_Traffic34_$i.txt
python3 basic1-1.py 34 12 $i > log_pre_Traffic12_$i.txt
done
for (( i = $1 ; i <= $2 ; i+=$3 ))
do
